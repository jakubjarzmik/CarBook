    ...
    <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-start">
            <div class="col-md-9 ftco-animate pb-5">
                <h1 class="mb-3 bread">Create Client</h1>
            </div>
        </div>
    </div>
</section>
...
<section class="ftco-section bg-light">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <form method="POST" id="form" action="/clients/create" class="bg-white p-5 contact-form">
                    @csrf
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <input name="email" type="email" class="form-control validate" id="email" placeholder="E-Mail" value="{{ $model->email }}">
